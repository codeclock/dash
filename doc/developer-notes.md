...
Suppo Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Suppo Core, where everyone uses
...
pay attention to for reviewers of Suppo Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Suppo Core uses tinyformat, which is type safe. Leave them out to avoid confusion
