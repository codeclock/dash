TOR SUPPORT IN Suppo Core
=======================

It is possible to run Suppo Core as a Tor hidden service, and connect to such services.
...
1. Run Suppo Core behind a Tor proxy
----------------------------------

The first step is running Suppo Core behind a Tor proxy. This will already make all
...
Suppo Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Suppo Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Suppo Core is listening, and
