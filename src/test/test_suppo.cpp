...
#define BOOST_TEST_MODULE Suppocoin Test Suite

#include "test_suppo.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_suppo_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
