 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Dash (https://www.suppocoin.io/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-h") ||  mapArgs.count("-help") || mapArgs.count("-version"))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  dashd [options]                     " + _("Start Suppo Core Daemon") + "\n";
