...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SuppoNetwork") type = SuppoNetwork;
    if(strType == "SuppoNetworkVariable") type = SuppoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SuppoNetwork) s = "SuppoNetwork";
    if(type == SuppoNetworkVariable) s = "SuppoNetworkVariable";
