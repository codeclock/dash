    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Suppo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Suppo Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  suppo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Suppocoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SUPPO, 0.1 SUPPO, 1 SUPPO and 10 SUPPO -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Suppo Core is shutting down...") + "<br /><br />" +
