    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Suppo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Suppocoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and suppo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Suppo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Suppo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Suppo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Suppocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Suppocoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a suppo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Suppo Core help message to get a list with possible Suppo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Suppo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Suppocoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Suppo Core"); // default title
