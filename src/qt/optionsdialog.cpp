    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SUPPO-light"), QVariant("light"));
    //ui->theme->addItem(QString("SUPPO-light-hires"), QVariant("light-hires"));
    //ui->theme->addItem(QString("DASH-blue"), QVariant("drkblue")); //only support light theme for now
