...
QT_TRANSLATE_NOOP("dash-core", "Copyright (C) 2017-%i The Suppo Core Developers"),
...
QT_TRANSLATE_NOOP("dash-core", "Error loading wallet.dat: Wallet requires newer version of Suppo Core"),
...
QT_TRANSLATE_NOOP("dash-core", "Initialization sanity check failed. Suppo Core is shutting down."),
...
QT_TRANSLATE_NOOP("dash-core", "Wallet needed to be rewritten: restart Suppo Core to complete"),
