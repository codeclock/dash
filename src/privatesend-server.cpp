...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Suppocoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Suppocoin and make it unusable. To
